...
function startCustomAdvertising(bleno, serviceUuids, scanData) {
...
exports.startCustomAdvertising = startCustomAdvertising;
function stopAdvertising(bleno) {
...
function buildAdvertisement(serviceUuids) {
