...
class WeworkBlewcCharacteristicIndicate extends Characteristic {
    constructor(ee) {
        super({
            uuid: 'FCC8',
            properties: ['indicate'],
...
exports.WeworkBlewcCharacteristicIndicate = WeworkBlewcCharacteristicIndicate;
//# sourceMappingURL=wework-blewc-characteristic-indicate.js.map